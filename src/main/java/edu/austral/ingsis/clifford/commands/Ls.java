...
public class Ls implements Command {
  ...
  // ls
  // Descripción: listar los elementos del directorio actual. Puede recibir el flag --ord que puede
  // recibir 2 parámetros asc o desc según se quiera un orden ascendente o descendente. En caso de
  // que no se agregue un parámetro, los elementos tendrán que ser listados en el orden en el que
  // fueron creados. Si el directorio está vacio, devolverá una linea vacia.
  //
  // Parámetros: ninguno
  //
  // Opciones:
  //
  // "--ord": define el algoritmo que tiene que usar para ordenar el output de los elements. Puede
  // recibir 2 valores: asc o desc.
