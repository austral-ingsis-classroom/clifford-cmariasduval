...
public class Mkdir implements Command {
  ...
  private void checkIfExists(Directory currentDirectory, String directoryName)
      throws FileSystemException {
  ...
  private void createDirectory(Directory currentDirectory, String directoryName)
      throws FileSystemException {
